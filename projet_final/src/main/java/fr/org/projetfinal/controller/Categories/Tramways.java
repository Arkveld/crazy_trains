...
@WebServlet(name = "/Tramways")
public class Tramways extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException { 
		try {
			List<Article> articles = articleMetier.findArticlesByCategorie(2);
		...
		request.getRequestDispatcher("/pages/categories/tramways.jsp").forward(request, response);
	}
}
